...
class KNearestNeighbor(object):
  ...
  def compute_distances_two_loops(self, X):
    ...
    # which is kind of like an iterator and generates the numbers on demand.(Lazy Evaluation)
    for i in xrange(num_test): # 500 loops 
      for j in xrange(num_train): # 5000 loops
        #####################################################################
        # TODO:                                                             #
  ...
  def predict_labels(self, dists, k=1):
    ...
    for i in xrange(num_test):
      ...
      #########################################################################
      closest_y = self.y_train[dists[i].argsort()[:k]] # if k = 1 : integer (0~9), if k = 5 : [6 2 4 4 4] 
      #########################################################################
      # TODO:                                                                 #
